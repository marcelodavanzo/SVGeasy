...
SVGeasy looks for Symbol Masters named `icon / icon-name / icon-size` (eg. icon / delete / 32) and exports them to a folder of your preference as optimised SVGs.

The output filename will be `icon-name_icon-size.svg` (eg. delete_32.svg).
